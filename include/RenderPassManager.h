...
public:
  ...
  // Creates the G-buffer pass: 3 color MRTs + depth, outputs to SHADER_READ_ONLY.
  void createGBufferRenderPass(VkDevice device,
                               VkFormat gb0Format, VkFormat gb1Format,
                               VkFormat gb2Format, VkFormat depthFormat);
  ...
  void createRenderPass(VkDevice device, VkFormat swapchainFormat, VkFormat colorFormat);
